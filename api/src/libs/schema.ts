export const ocrschema = {
  ...
  birthdate:
    "tanggal lahir pemohon (berdasarkan IDPB atau KTP) dengan format YYYY-MM-DD",
  birthplace: "tempat lahir pemohon (berdasarkan IDPB atau KTP)",
  ...
  ktp_pos_code: "kodepos pemohon sesuai kk",
  ...
  aw_birthdate:
    "tanggal lahir ahliwaris sesuai KTP Ahliwaris dengan format YYYY-MM-DD",
  aw_job: "pekerjaan ahliwaris sesuai KTP Ahliwaris",
  aw_birthplace: "tempat lahir ahliwaris sesuai KTP Ahliwaris",
